...
if __name__ == '__main__':
  ...
  timelineStandardLog('SYSLOG', 'collection/artifacts/system.log')
  timelineStandardLog('APPFirewall', 'collection/artifacts/appfirewall.log')
  timelineStandardLog('INSTALL', 'collection/artifacts/install.log')
  timelineStandardLog('ACCOUNTPOLICY', 'collection/artifacts/accountpolicy.log')
  timelineQuarantine('collection/artifacts/com.apple.LaunchServices.QuarantineEventsV2')